    ...
    <body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #48B749;">
        ...
        <![endif]-->
            ...
            <div style="max-height:0; overflow:hidden; mso-hide:all;" aria-hidden="true">
                Non-Transaction Webhook hit fgr-budget-webhook
            </div>
            ...
            <div style="max-width: 600px; margin: 0 auto;" class="email-container">
                ...
                <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                                ...
                                <tr>
                                    <td
                                        ...
                                        <h1 class="new_tranaction_title"
                                            ...
                                            Non-Transaction Webhook Notification</h1>
    
                                        <p style="margin: 0; text-align: center;">There was a Non-Transaction webhook received by the fgr budget webhook.</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <!-- 1 Column Text : BEGIN -->
                    <!-- Must split code up with comma and space for easy readability str.replace(",", ", "); -->
                    <tr>
                        <td style="background-color: #E5E6E5;">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                ...
                <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                    ...
                    <tr>
                        <td
                            ...
                            <br><br>
                            FGR Solutions<br><span class="unstyle-auto-detected-links">Detroit, MI.</span>
                            <br><br>
                        </td>
                    </tr>
                </table>
