...
module.exports = async function(req,new_transactions){
  ...
  for(let i =0;i<new_transactions.length;i++){
      ...
      if(bank == "UNKNOWN"){
        ...
        //If this is not the first transaction (This is for email style purposes)
      if(i != 0){
        ...
        <td
            ...
            <ul style="padding: 0; margin: 0 0 10px 0; list-style-type: disc;">
                ...
                ${name}</li>
                <li style="margin: 0 0 0 30px;" class="list-item-last"><span
                        style="font-weight: bold;">AMOUNT:</span> ${amount}</li>
            </ul>
        </td>
      </tr>`
      }else{
